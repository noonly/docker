...
if [ "_$y" == "_y" ]; then
	...
	docker run -d --name wwwroot --hostname wwwroot -p 80:80 -p 443:443 -v /docker/nginx-www/conf.d/:/usr/local/openresty/nginx/conf/conf.d/:rw --env CONSUL_HOST=$CONSUL_IP noonly/www
